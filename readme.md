...
![本月出勤異常](assets/readme/v1.3.1/attendance-abnormalities-v1.3.1.png)

#### 🕒 本月打卡記錄 (v1.3.1 新增)

![本月打卡記錄](assets/readme/v1.3.1/punch-records-v1.3.1.png)

#### ⚙️ 加班時數補報

![加班時數補報](assets/readme/v1.3.1/overtime-report-v1.3.1.png)

#### 📊 個人記錄

![個人記錄](assets/readme/v1.3.1/personal-record-v1.3.1.png)
