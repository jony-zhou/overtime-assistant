...
class PersonalRecordTab(ctk.CTkFrame):
    ...
    def _create_table(self):
        ...
        # 建立 Treeview
        columns = ("date", "content", "status", "hours", "monthly", "quarterly", "report")
        ...
        # 佈局
        self.tree.pack(side="left", fill="both", expand=True, padx=spacing.md, pady=spacing.md)
    ...
    def display_records(self, records: List[PersonalRecord], summary: PersonalRecordSummary):
        """
        顯示個人記錄
